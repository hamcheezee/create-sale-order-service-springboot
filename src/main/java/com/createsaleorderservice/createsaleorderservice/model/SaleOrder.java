...
public class SaleOrder {
    ...
    private Integer purchase_order_number;
    ...
    public SaleOrder(Integer purchase_order_number, Integer order_number, String purchase_order_date,
            String delivery_date, String order_status, String material_code, String material_name, int quantity,
            float unit_cost, float subtotal, float tax, float total_net_price, String billing_address,
    ...
    public Integer getPurchase_order_number() {
        return purchase_order_number;
    }

    public void setPurchase_order_number(Integer purchase_order_number) {
        this.purchase_order_number = purchase_order_number;
    }
